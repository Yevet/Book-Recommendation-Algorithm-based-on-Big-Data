...
DATAPATH1 = 'hdfs://master:9000/test/万历十五年.TXT'
DATAPATH2 = 'hdfs://master:9000/usr/hadoop/test/stop_words.txt'
SAVEPATH = '/home/hadoop/Ex2_WordCount/results'
...
def wordcount(isvisualize=False):
    ...
    """
    # 读取停用词表
    stopwords = getStopWords(DATAPATH2)

    # 结巴分词
    words_list = jiebaCut(DATAPATH1)
